...
const useMarvelService = () => {
  const { loading, request, error, process, clearError } = useHttp();
  ...
  return { loading, error, process, clearError, getAllCharacters, getCharacter, getAllComics, getComic, getCharacterByName };
};
